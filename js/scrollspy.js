...
function scrollSpy(){
	...
	//we get the divs offsets looping the menu links and getting the targets (this is dynamic: when we change div #about's height, code won't break!)
	var divs = [];
	$(".menu a").each(function(i) {
		var appo = $(this).data("target");
...
//about div height click
$('#expander').click(function(){
	$("#about").toggleClass('aug');
});
			});